...
% cell faces.
function [coeffs_x, coeffs_r] = green_gauss_like_scheme(grid, field_bd_conditions)
    arguments
        grid (1,1) Grid2D
    ...
    coeffs_r(:,:,1) = -center_inv_distance_r .* [grid.face_pos_r(1) grid.cent_pos_r] ./ grid.face_pos_r;
    coeffs_r(:,:,2) = center_inv_distance_r .* [grid.cent_pos_r grid.face_pos_r(end)] ./ grid.face_pos_r;
