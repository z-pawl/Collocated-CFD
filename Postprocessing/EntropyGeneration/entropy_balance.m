function [rel_diff, s_gen, s_inlet, s_outlet, s_wall, s_inlet_conv, s_inlet_heat, s_inlet_diff] = entropy_balance(grid, energy, flow, species_manager, ent_gen_total, SC)
